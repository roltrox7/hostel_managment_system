...
class Department(models.Model):
    dno = models.CharField(primary_key=True, max_length=5)
    dname = models.CharField(max_length=15)
    dloc = models.CharField(max_length=15, blank=True, null=True)
...
class Employee(models.Model):
    essn = models.CharField(primary_key=True, max_length=5)
...
class Hostel(models.Model):
    hid = models.CharField(primary_key=True, max_length=5)
    hname = models.CharField(max_length=15, blank=True, null=True)
    hloc = models.CharField(max_length=15, blank=True, null=True)
    nrooms = models.IntegerField(blank=True, null=True)
    warden_ssn = models.ForeignKey(Employee, models.DO_NOTHING, db_column='warden_ssn', blank=True, null=True)
...
class Rooms(models.Model):
    ...
    tableid = models.CharField(unique=True, max_length=5, blank=True, null=True)
    chairid = models.CharField(unique=True, max_length=5, blank=True, null=True)
    hid = models.ForeignKey(Hostel, models.DO_NOTHING, db_column='hid', blank=True, null=True)
...
class Student(models.Model):
    ...
    age = models.IntegerField(blank=True, null=True)
    gender = models.CharField(max_length=1, blank=True, null=True)
    roomid = models.ForeignKey(Rooms, models.DO_NOTHING, db_column='roomid', blank=True, null=True)
